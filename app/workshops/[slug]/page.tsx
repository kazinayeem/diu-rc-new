          ...
          >
            ...
            <div className="mb-6">
              ...
              <div className="flex flex-wrap gap-3 mb-4">
                ...
                <span className="px-4 py-2 rounded-full text-sm font-medium bg-orange-100 dark:bg-orange-500/20 text-orange-700 dark:text-orange-300 border border-orange-300 dark:border-orange-400/40">
                  🛠️ Workshop
                </span>
                ...
                <>
                  ...
                  {event.registrationOpen && (event.spotsRemaining === null || event.spotsRemaining === undefined || event.spotsRemaining > 0) ? (
                    ...
                    <div className="w-full bg-red-100 dark:bg-red-500/20 text-red-700 dark:text-red-300 font-bold py-4 px-4 rounded-lg text-center border border-red-300 dark:border-red-400/40">
                      <p className="text-lg">🚫 Workshop Fully Booked</p>
                      <p className="text-sm mt-2">All {event.registrationLimit} seats have been filled. This workshop is no longer accepting registrations.</p>
                    </div>
                  ) : (
