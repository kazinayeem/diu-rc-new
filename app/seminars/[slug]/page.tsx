...
export default function SeminarDetailsPage() {
  ...
  useEffect(() => {
    if (!slug) {
      setError("Seminar slug not provided");
      setLoading(false);
      return;
    }
      ...
      <div className="min-h-screen flex flex-col items-center justify-center bg-white dark:bg-transparent px-4">
        ...
        >
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 mb-6 max-w-md">
            {error || "The seminar you're looking for doesn't exist or has been removed."}
          </p>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          >
            ...
            <div className="mb-6">
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                ...
                <span className={`px-4 py-2 rounded-full text-xs sm:text-sm font-medium bg-blue-100 dark:bg-blue-500/20 text-blue-700 dark:text-blue-300 border border-blue-300 dark:border-blue-400/40`}>
                  🎓 Seminar
                </span>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          >
            ...
            <div className="mb-8">
              <h2 className="text-2xl md:text-3xl font-bold mb-6">About This Seminar</h2>
              ...
              {event.content && (
                <div className="mt-6 p-6 md:p-8 bg-gray-50 dark:bg-white/5 rounded-2xl">
                  <h3 className="text-lg md:text-xl font-semibold mb-6">Seminar Details</h3>
            ...
            {event.hosts && event.hosts.length > 0 && (
              <div className="mb-8">
                <h2 className="text-2xl md:text-3xl font-bold mb-6">Speakers</h2>
            ...
            <div className="sticky top-24 bg-white dark:bg-white/5 rounded-2xl p-5 border border-gray-200 dark:border-white/10 shadow-xl backdrop-blur-sm">
              ...
              >
                <div className="flex justify-between items-center text-xs">
                  ...
                  <span className="font-semibold text-gray-800 dark:text-gray-200">Seminar</span>
                </div>
                {event.mode && (
                  <div className="flex justify-between items-center text-xs">
