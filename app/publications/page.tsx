    ...
    <div className="min-h-screen py-16 px-4 md:px-8 bg-transparent">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
        {papers.map((paper: any, index: number) => (
          <div
            key={index}
            className="bg-[#111827] shadow-xl shadow-black/30 rounded-2xl p-6 border border-[#1f2937] hover:shadow-2xl hover:shadow-black/50 transition"
          >
            {/* Title */}
            ...
            <p className="mt-3 text-gray-300 text-sm">
              <span className="font-semibold text-gray-200">Authors:</span>{" "}
